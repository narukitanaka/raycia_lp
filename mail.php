...
$site_top = "https://greenx0.xsrv.jp/raycia_lp/";
...
$thanksPage = "https://greenx0.xsrv.jp/raycia_lp/thanks.html";
...
<!-- ▼************ 送信内容表示部　※編集は自己責任で ************ ▼-->
<div id="formWrap">
<h1><img src="images/logo.png" alt="うえほんまち歯科ロゴ" /></h1>
<div class="img_area" style="margin-bottom: 50px;"><img src="images/thanks_01.jpg" alt="" /></div>
<?php if($empty_flag == 1){ ?>
<div align="center">
<h4>入力にエラーがあります。下記をご確認の上「戻る」ボタンにて修正をお願い致します。</h4>
<?php echo $errm; ?><br /><br /><input type="button" value=" 前画面に戻る " onClick="history.back()" class="btn">
</div>
<?php }else{ ?>
<h3>確認画面</h3>
<p align="center" class="confi_text">以下の内容で間違いがなければ、「送信する」ボタンを押してください。</p>
